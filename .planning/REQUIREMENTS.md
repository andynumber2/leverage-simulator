...
- [ ] **PERF-01**: A performance budget file defines numeric thresholds for every metric in
      PERF-02 through PERF-09, and CI fails the build when a measured value exceeds its budget
- [ ] **PERF-01a**: The thresholds below are **provisional**. The performance spike measures what
...
- [ ] **PERF-10**: A benchmark suite runnable locally with one command reports all of the above,
